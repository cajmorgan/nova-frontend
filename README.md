...
<dl>
<dt><a href="#WhatIs">What is Nove?</a></dt>
<dd></dd>
...
header.elements[1].addEventListener("click", () => {
  state.dispatch(
    state.getAction("whateverAction", {
      appendText: "HELLO",
      field: "whateverText",
    })
  );
...
const h2 = new Element(
  "h2",
  root,
  { id: "subtitle", innerText: "To an awesome page!" },
  true
);
...
const h1 = new Element(
  "h1",
  root,
  { id: "welcome", innerText: "Hello World!" },
  true
);
