...
module.exports = class Element {
  ...
  constructor(type, parent, elementObject, init, addedNode) {
    this.#type = type;
    this.#parent = parent.node ? parent.node : parent;
    this.#node = addedNode || null;
    this.#elementObject = elementObject;
    this.#removed = addedNode ? false : true;
    this.#init = init
    !addedNode && this.#createNode();
    !addedNode && this.#checkInit();
  }

  static getElementFromId(id) {
    const node = document.getElementById(id);
    const createdElement = new Element(node.tagName.toLowerCase(), node.parentNode, {}, false, node);
